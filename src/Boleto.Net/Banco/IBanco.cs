...
namespace BoletoNet
{
    public interface IBanco
    {
        ...
        /// <summary>
        /// Gera os registros de detalhe do arquivo de remessa - SEGMENTO Y
        /// </summary>
        string GerarDetalheSegmentoYRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo);
